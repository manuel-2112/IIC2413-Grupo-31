    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="views/perfil.php" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i></a>
                            ...
                            <?php
                              foreach ($eventos as $evento) {
                                ...
                                <form action="consultas/detalles_evento.php" method="post"> 
                                   <input type = 'hidden'  value='<?php echo($evento[0]) ?>' name = 'evento'>
