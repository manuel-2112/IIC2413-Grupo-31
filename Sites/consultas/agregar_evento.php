...
<?php
    ...
    $estado = 'en espera';
 	$query = "INSERT INTO Evento (id_ev, nombre,fecha_inicio, fecha_termino, estado)
     VALUES ($id_ev, '$nombre', '$fecha_inicio', '$fecha_termino','$estado')";
...
<section class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Sidebar Toggle-->
        <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="../views/perfil.php"><i class="fas fa-bars"></i></button>
        <!-- Navbar Search-->
